...
mkdir -p %{_builddir}/Polaris
tar -xzf %{SOURCE0} -C %{_builddir}/Polaris

# list directory
ls -a %{_builddir}/Polaris
...
%{_userunitdir}/polaris.service

# Desktop entries
%{_datadir}/applications/*.desktop

# Icons
%{_datadir}/icons/hicolor/scalable/apps/polaris.svg
%{_datadir}/icons/hicolor/scalable/status/polaris*.svg
